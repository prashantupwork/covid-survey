...
const Form = ({ filledState = {}, setFormState, form }) => {
  ...
  const handleSubmit = async e => {
    ...
    Object.entries(status).forEach(([key, value]) => {
      ...
      if(value.show) {
        newServey = { ...newServey, [key]: value.answer}
      }
    ...
    console.log(newServey);

    await axios.post(BASIC_URL + "/surveyData", newServey)
    .then(res => {
    ...
    if( name === "relation" ) {
      ...
      switch(value) {
        ...
        case "partner":
          ...
          break;
        case "son":
          afterValue = t('houseMembersList.options.son');
          break;
        case "daughter":
          afterValue = t('houseMembersList.options.daughter');
          break;
        case "other":
    ...
    if( name === "relation" || name === "disease" ) {
      ...
      switch(value) {
        ...
        case "partner":
          ...
          break;
        case "son":
          afterValue = t('diseaseMembersList.options.son');
          break;
        case "daughter":
          afterValue = t('diseaseMembersList.options.daughter');
          break;
        case "other":
  ...
  return (
    <FormBox>
      <form onSubmit={handleSubmit}>
        ...
        <hr className="mb-5 mt-5" />
        <InputQuestion
          title={t('cellPhoneNumber.question')}
          onChange={( event ) => {
                      ...
                      <tr key={idx}>
                        ...
                        <td style={{width: '30%', textAlign: 'center'}}>
                          ...
                          >
                            ...
                            <option value="son">{t('houseMembersList.options.son')}</option>
                            <option value="daughter">{t('houseMembersList.options.daughter')}</option>
        ...
        {status['guarani'].show && (
          <>
            ...
            <Question
              ...
              onChange={({ value }) => {
                handleQuestion('guarani', value, 'symptomsType')
              }}
                      ...
                      <tr key={idx}>
                        ...
                        <td style={{width: '30%', textAlign: 'center'}}>
                          ...
                          >
                            ...
                            <option value="son">{t('diseaseMembersList.options.son')}</option>
                            <option value="daughter">{t('diseaseMembersList.options.daughter')}</option>
        ...
        <hr className="mb-5 mt-5" />
        <InputQuestion
          title={t('employeesNumber.question')}
          onChange={(event) => {
        ...
        <hr className="mb-5 mt-5" />
        <InputQuestion
          title={t('layOffEmployees.question')}
          onChange={(event) => {
        ...
        <hr className="mb-5 mt-5" />
        <InputQuestion
          title={t('amountMarchMoney.question')}
          onChange={(event) => {
        ...
        <hr className="mb-5 mt-5" />
        <InputQuestion
          title={t('amountAprilMoney.question')}
          onChange={(event) => {
        ...
        <hr className="mb-5 mt-5" />
        <InputQuestion
          title={t('shareWorkplace.question')}
          onChange={(event) => {
